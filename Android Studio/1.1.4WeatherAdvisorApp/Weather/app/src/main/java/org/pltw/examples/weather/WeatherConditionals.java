...
public class WeatherConditionals {
    ...
    public static String getHikingAdvice(int temperature, int windchill, int humidity, String condition){
        if (temperature >= 100 && condition.toLowerCase().contains("snow")) {
            return "I somehow doubt it's snowing in " + Integer.toString(temperature) + " degree heat";
        }
        else if (temperature <= 32) {
            ...
            return Integer.toString(temperature) + " degrees, " + Integer.toString(windchill) + "windchill, " + "humidity of " + Integer.toString(humidity) + "percent and " + condition;
        }
        }
